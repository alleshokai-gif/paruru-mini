...
assert.deepStrictEqual(JSON.parse(JSON.stringify(api.resolveHomeAgentReadActor_({ deviceId: 'mother-phone', pairingToken: 'pairing' }))), { homeId: 'home-a', memberUserId: 'mother', displayName: '母', role: 'guardian', capabilities: ['home.read', 'calendar.family.read', 'calendar.family.create', 'calendar.family.edit_own', 'calendar.family.delete_own', 'memo.self.read', 'memo.self.create', 'memo.self.update', 'memo.self.delete', 'health.self.read', 'health.self.record', 'health.supervision.read', 'health.supervision.record'], deviceId: 'mother-phone' });
assert.deepStrictEqual(JSON.parse(JSON.stringify(api.getMembershipContext_({ deviceId: 'mother-phone', pairingToken: 'pairing' }))), { memberUserId: 'mother', displayName: '母', role: 'guardian', calendarSuffix: '（母）', capabilities: ['home.read', 'calendar.family.read', 'calendar.family.create', 'calendar.family.edit_own', 'calendar.family.delete_own', 'memo.self.read', 'memo.self.create', 'memo.self.update', 'memo.self.delete', 'health.self.read', 'health.self.record', 'health.supervision.read', 'health.supervision.record'], allowedViews: ['home', 'inbox', 'nurse-okan'] });
