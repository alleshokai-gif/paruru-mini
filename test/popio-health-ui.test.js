...
async function run() {
  ...
  assert(
    baselineViews.includes("'popio-health'")
      && /admin: Object\.freeze\(\[[^\]]*'popio-health'/.test(roleViews)
      && roleViews.includes('guardian: BASELINE_ALLOWED_VIEWS')
      && roleViews.includes('self_record: BASELINE_ALLOWED_VIEWS'),
