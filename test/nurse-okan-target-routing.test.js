...
['health.context.get','health.daily.get','health.daily.list','health.daily.recordSlot','health.weight.list','health.weight.record','health.weight.correct'].forEach(action=>{
