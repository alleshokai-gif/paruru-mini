(function () {
  ...
  function openNursePanel_(event){state.pendingOpen=event&&event.detail&&event.detail.action==='daily'?event.detail:null;if(!state.context){loadContext_();}else{focusPendingOpen_();}}
