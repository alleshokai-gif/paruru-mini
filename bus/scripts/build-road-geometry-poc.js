...
try {
  ...
  const artifact={schemaVersion:1,provider:'kawasaki',sourceType:'validated_road_geometry',
    ...
    attribution:{osm:{text:'© OpenStreetMap contributors',url:'https://www.openstreetmap.org/copyright',license:'ODbL 1.0',
      licenseUrl:'https://opendatacommons.org/licenses/odbl/1-0/',relationId:stitched.relation.id,
      version:stitched.relation.version,timestamp:stitched.relation.timestamp,sourceSha256:sha256(osmBytes)},
      mlit:{text:'「国土数値情報（バスルートデータ）」（国土交通省）をもとにPALURUが検証のため加工',
        siteAttribution:'出典：国土交通省国土数値情報ダウンロードサイト',
        url:'https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-N07-v2_0.html',
        termsUrl:'https://nlftp.mlit.go.jp/ksj/other/agreement.html',year:2022,sourceSha256:sha256(n07Bytes)}},
