...
const FAMILY_INBOX_WORKER_PROFILES = Object.freeze({
  ...
  'school-v1-long': Object.freeze({
    profile: 'school-v1-long', model: 'gpt-5.6-luna', extractorVersion: 'family-inbox-worker/1.7.0',
    promptVersion: 'school-v1-long/1.5.0', maxItems: FAMILY_INBOX_LONG_MAX_ITEMS, allowReviewItems: true,
  }),
});
